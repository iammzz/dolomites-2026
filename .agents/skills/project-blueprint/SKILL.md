...
description: Complete project architecture, planning workflow, and deployment guide for the Dolomites 2026 trip website. Use when asked about project structure, how the site is built, or how to set up a similar trip planning project.
---

# 🏔️ Project Blueprint: Dolomites 2026
...
│   ├── day1_*.md .. day16_*.md # Daily detailed itineraries
...
### Phase 1: Structure
1. Define date range, day-by-day skeleton, base towns
...
2. Site available at `dolomites.teaham.ca`
