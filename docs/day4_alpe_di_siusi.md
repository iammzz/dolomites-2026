...
## ✅ Main Activity: Biking or Hiking the Mega-Meadow
...
|---|------|----|----------|------------|------|-------|
| 1 | Ortisei | Compatsch (P2 Parking) | 16 km | ~30 min | SS242, LS24 | **MUST pass control point before 9:00 AM.** |
| 2 | Compatsch | Ortisei | 16 km | ~30 min | LS24, SS242 | Drive down anytime after sunset. |
...
| 9:15 am | Compatsch | 🚲 E-Bikes Out | ✅ **DONE — picked up at 9:15** (Alpin Center Rent Lodge, Compatsch 52 — 1-min walk from P2). |
...
| 3:45 pm | Compatsch loop | 🚴 Final Leg | Head back north across the meadow toward Compatsch. |
