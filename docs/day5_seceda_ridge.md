...
|---|------|----|----------|------------|------|-------|
| 1 | Ortisei | Seceda Cable Car Station | 0 km | 0 min | Walk | The station is right in town (north side). |
| 2 | Ortisei | Passo Sella (Optional) | 20 km | ~35 min | SS242 | Incredible drive up to the pass. |

### 🕐 Hour-by-Hour Schedule

| Time | Location | Activity | Detail |
|------|----------|----------|--------|
| 8:30 am | Ortisei | 🚶 Walk to Gondola | Walk to the Seceda cable car station. |
| 9:00 am | Seceda Station | 🚡 Ride Up | Take the two-stage cable car to the top (2,500m). |
| 9:15 am | Seceda Summit | 📸 The Viewpoint | Snap the iconic photo before clouds roll in. |
| 9:30 am | Seceda Ridge | 🥾 Hike to Pieralongia | Follow the trail along the ridge edge. |
| 10:30 am | Panascharte (Forcella Pana) | 📸 Viewpoint | Epic views at the dramatic notch in the Odle peaks. |
| 11:30 am | Malga Pieralongia | ☕ Snack Stop | Grab a coffee or Kaiserschmarrn among the donkeys. |
| 1:00 pm | Seceda Station | 🚡 Ride Down | Return to Ortisei. |
| 2:00 pm | Ortisei | 🍽️ Late Lunch | Grab lunch in the pedestrian center. |
| 3:30 pm | Val Gardena | 🚗 Drive to Passo Sella | (Optional) If the weather is good, drive the pass! |
